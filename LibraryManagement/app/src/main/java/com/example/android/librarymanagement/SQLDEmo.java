...
class SqliteController extends SQLiteOpenHelper {
...
database.execSQL(query); Log.d(LOGCAT,"Students Created");
 }
...
values.put("StudentName", queryValues.get("StudentName"));
 database.insert("Students", null, values); database.close(); 
}
**********/
/*********Update Table Data
...
************/
/**********
public void deleteStudent(String id) { Log.d(LOGCAT,"delete"); 
SQLiteDatabase database = this.getWritableDatabase();	
